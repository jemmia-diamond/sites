  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "flex justify-between items-center gap-1.5 rounded-full pl-2 pr-2 py-0.5 w-[140px] text-[11px] font-bold tracking-widest border-none shadow-sm uppercase whitespace-nowrap transition-colors cursor-pointer",
