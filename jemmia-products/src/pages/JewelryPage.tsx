...
export default function JewelryPage() {
  ...
  return (
    <LayoutShell searchPlaceholder="Nhập mã để bắt đầu tìm kiếm">
      ...
      <main className="flex-1 flex flex-col md:gap-0 xl:gap-2 xl:gap-4 bg-white px-4 xl:px-6 pt-4 md:pt-0 xl:pt-4 pb-6 w-full max-w-full min-w-0 xl:overflow-hidden min-h-0">
        <div className="sticky top-12 xl:top-0 z-51 w-full bg-white flex justify-between gap-4 py-2 xl:py-0">
